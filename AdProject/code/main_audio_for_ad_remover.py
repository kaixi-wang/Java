    ...
    for i in range(0, len(y), audio_frame_size):
        ...
        if energy_frame < energy_threshold:
            ...
            if i - last_local_min > valid_energydrop_threshold:
                ...
                print(energy_frame,energy_threshold,last_local_min)
                last_local_min = i
                # Save screenshot
...
def main():
    # AUDIO ANALYSIS
    analyze_audio(0, 14000000, 'dataset3/Videos/data_test3.wav')

    energy_transform(audio_frame_size, energy_threshold, y)
...
def analyze_audio(startFrame, endFrame, input_audio):
    ...
    audio_frame_size = 1000
    energy_threshold = 51
    return energy_transform(audio_frame_size, energy_threshold, y_sample)



def main():
    # AUDIO ANALYSIS
    return analyze_audio(0, 14000000, 'dataset3/Videos/data_test3.wav')
